...
function loadOrganizations() {
    ...
    if (storedOrganizations) {
        ...
        // Production: Start with empty organizations array
        // Organizations should be created through the UI
        organizations = [];
        saveOrganizations();
    }
...
function loadData() {
    ...
    if (storedProviders) {
        ...
        // Production: Start with empty providers array
        providers = [];
        saveProviders();
    }
    ...
    if (storedPayers) {
        ...
        // Production: Start with empty payers array
        payers = [];
        savePayers();
    }
    ...
    if (storedEnrollments) {
        ...
        // Production: Start with empty enrollments array
        enrollments = [];
        saveEnrollments();
    }
    ...
    if (storedLocations) {
        ...
        // Production: Start with empty locations array
        locations = [];
        saveLocations();
    }
...
function loadContracts() {
    ...
    if (storedContracts) {
        ...
        // Production: Start with empty contracts array
        contracts = [];
        saveContracts();
    }
}
